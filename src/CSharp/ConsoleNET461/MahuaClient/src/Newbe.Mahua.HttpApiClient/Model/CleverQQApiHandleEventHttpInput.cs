...
namespace Newbe.Mahua.HttpApiClient.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class CleverQQApiHandleEventHttpInput :  IEquatable<CleverQQApiHandleEventHttpInput>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CleverQQApiHandleEventHttpInput" /> class.
        /// </summary>
        ...
        public CleverQQApiHandleEventHttpInput(string 响应QQ = default(string), int? 请求类型 = default(int?), string 对象QQ = default(string), string 群号 = default(string), int? 处理方式 = default(int?), string 附加信息 = default(string))
        {
            this.响应QQ = 响应QQ;
            this.请求类型 = 请求类型;
            this.对象QQ = 对象QQ;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class CleverQQApiHandleEventHttpInput {\n");
        ...
        {
            return this.Equals(input as CleverQQApiHandleEventHttpInput);
        }

        /// <summary>
        /// Returns true if CleverQQApiHandleEventHttpInput instances are equal
        /// </summary>
        /// <param name="input">Instance of CleverQQApiHandleEventHttpInput to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CleverQQApiHandleEventHttpInput input)
        {
            if (input == null)
                return false;
