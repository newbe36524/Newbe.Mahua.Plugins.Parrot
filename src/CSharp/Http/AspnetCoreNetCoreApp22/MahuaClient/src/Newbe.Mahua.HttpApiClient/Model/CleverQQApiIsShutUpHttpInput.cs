...
namespace Newbe.Mahua.HttpApiClient.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class CleverQQApiIsShutUpHttpInput :  IEquatable<CleverQQApiIsShutUpHttpInput>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CleverQQApiIsShutUpHttpInput" /> class.
        /// </summary>
        /// <param name="响应QQ">机器人QQ.</param>
        /// <param name="群号">欲查询的群号.</param>
        /// <param name="对象QQ">需要查询的对象QQ.</param>
        public CleverQQApiIsShutUpHttpInput(string 响应QQ = default(string), string 群号 = default(string), string 对象QQ = default(string))
        {
            this.响应QQ = 响应QQ;
            this.群号 = 群号;
            this.对象QQ = 对象QQ;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class CleverQQApiIsShutUpHttpInput {\n");
        ...
        {
            return this.Equals(input as CleverQQApiIsShutUpHttpInput);
        }

        /// <summary>
        /// Returns true if CleverQQApiIsShutUpHttpInput instances are equal
        /// </summary>
        /// <param name="input">Instance of CleverQQApiIsShutUpHttpInput to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CleverQQApiIsShutUpHttpInput input)
        {
            if (input == null)
                return false;
