...
namespace Newbe.Mahua.HttpApiClient.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class MpqApiKickHttpInput :  IEquatable<MpqApiKickHttpInput>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="MpqApiKickHttpInput" /> class.
        /// </summary>
        /// <param name="响应的QQ">响应的QQ.</param>
        /// <param name="群号">群号.</param>
        /// <param name="对象">对象.</param>
        public MpqApiKickHttpInput(string 响应的QQ = default(string), string 群号 = default(string), string 对象 = default(string))
        {
            this.响应的QQ = 响应的QQ;
            this.群号 = 群号;
            this.对象 = 对象;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class MpqApiKickHttpInput {\n");
        ...
        {
            return this.Equals(input as MpqApiKickHttpInput);
        }

        /// <summary>
        /// Returns true if MpqApiKickHttpInput instances are equal
        /// </summary>
        /// <param name="input">Instance of MpqApiKickHttpInput to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(MpqApiKickHttpInput input)
        {
            if (input == null)
                return false;
