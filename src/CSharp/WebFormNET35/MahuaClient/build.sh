...
${nuget_cmd} install src/Newbe.Mahua.HttpApiClient/packages.config -o packages;
...
echo "[INFO] Run 'mcs' to build bin/Newbe.Mahua.HttpApiClient.dll"
mcs -langversion:${langversion} -sdk:${sdk} -r:bin/Newtonsoft.Json.dll,bin/JsonSubTypes.dll,\
bin/RestSharp.dll,\
System.ComponentModel.DataAnnotations.dll,\
System.Runtime.Serialization.dll \
-target:library \
-out:bin/Newbe.Mahua.HttpApiClient.dll \
-recurse:'src/Newbe.Mahua.HttpApiClient/*.cs' \
-doc:bin/Newbe.Mahua.HttpApiClient.xml \
-platform:anycpu
...
then
  ...
  echo "[INFO] bin/Newbe.Mahua.HttpApiClient.dll was created successfully"
fi
